      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            <div className="absolute -top-4 -left-4 w-72 h-72 bg-[#F59E0B]/20 rounded-full blur-3xl -z-10"></div>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
              <img 
                ...
                alt="Oxford Public School Students" 
                className="w-full h-[400px] md:h-[500px] object-cover hover:scale-105 transition-transform duration-700"
              />
            </div>

            {/* Floating Trust Badge */}
            <div className="absolute -bottom-6 md:-bottom-8 -right-4 md:-right-8 bg-white p-4 md:p-6 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] flex items-center gap-4 animate-bounce-slow border-b-4 border-[#F59E0B]">
          ...
          <div className="w-full lg:w-1/2 mt-8 lg:mt-0">
            <div className="flex items-center gap-2 mb-4">
              <span className="w-10 h-1 bg-[#F59E0B] rounded-full"></span>
              <span className="text-[#F59E0B] font-bold tracking-wider uppercase text-sm">About Our Institution</span>
            </div>
            
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#1E3A8A] leading-tight mb-6">
              Welcome to <span className="text-[#F59E0B]">Oxford Public School</span>
            </h2>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link 
                to="/about-us" 
                className="bg-[#1E3A8A] text-white px-8 py-3 rounded-md font-bold hover:bg-[#F59E0B] transition-colors duration-300 shadow-lg flex items-center gap-2"
              >
                <BookOpen size={20} />
                Read More
              </Link>
