        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2 relative">
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-[#F59E0B] rounded-tl-3xl rounded-br-3xl -z-10"></div>
              ...
              />
              <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg border-l-4 border-[#F59E0B] hidden md:block">
            ...
            <div className="w-full lg:w-1/2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-[#F59E0B] font-bold tracking-wider uppercase text-sm">Our Story</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#1E3A8A] mb-6">
                Nurturing Young Minds Since 2014
              </h2>
              <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                Oxford Public School was established with a dream to provide quality and holistic education to students in Shahjahanpur. Over the years, we have grown into a premier institution that balances traditional values with modern teaching methodologies.
              </p>
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <li className="flex items-center gap-3 text-[#1E3A8A] font-semibold">
                  <CheckCircle className="text-[#F59E0B]" size={20} /> Smart Classrooms
                </li>
                <li className="flex items-center gap-3 text-[#1E3A8A] font-semibold">
                  <CheckCircle className="text-[#F59E0B]" size={20} /> Experienced Faculty
                </li>
                <li className="flex items-center gap-3 text-[#1E3A8A] font-semibold">
                  <CheckCircle className="text-[#F59E0B]" size={20} /> Sports Facilities
                </li>
                <li className="flex items-center gap-3 text-[#1E3A8A] font-semibold">
                  <CheckCircle className="text-[#F59E0B]" size={20} /> Holistic Development
                </li>
              </ul>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            {/* Vision Card */}
            <div className="bg-gray-50 rounded-2xl p-8 lg:p-10 border-t-4 border-[#F59E0B] shadow-md hover:shadow-xl transition-shadow duration-300">
              <div className="w-16 h-16 bg-[#F59E0B] rounded-2xl flex items-center justify-center mb-6 transform rotate-3">
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="flex items-center justify-center gap-2 mb-4">
              <span className="w-8 h-1 bg-[#F59E0B] rounded-full"></span>
              <span className="text-[#F59E0B] font-bold tracking-wider uppercase text-sm">Core Values</span>
              <span className="w-8 h-1 bg-[#F59E0B] rounded-full"></span>
            </div>
