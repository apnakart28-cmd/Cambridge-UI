      ...
      <div className="bg-[#1E3A8A] py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-4">
            Our <span className="text-[#F59E0B]">Infrastructure</span>
          </h1>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="w-full lg:w-1/2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-[#F59E0B] font-bold tracking-wider uppercase text-sm">Campus Overview</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#1E3A8A] mb-6">
                A World-Class Environment for Holistic Growth
              </h2>
              <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                Spread across a sprawling, lush green campus, Oxford Public School offers a serene and pollution-free environment ideal for learning. Our architecture is designed to maximize natural light and ventilation, ensuring student comfort throughout the year.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-start gap-4">
                  <div className="bg-[#FFFBEB] text-[#F59E0B] p-3 rounded-lg">
                    <Wifi size={24} />
                  </div>
                  <div>
            ...
            <div className="w-full lg:w-1/2 relative">
              <div className="absolute top-4 -right-4 w-full h-full bg-[#F59E0B] rounded-2xl -z-10"></div>
              <img 
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="flex items-center justify-center gap-2 mb-4">
              <span className="w-8 h-1 bg-[#F59E0B] rounded-full"></span>
              <span className="text-[#F59E0B] font-bold tracking-wider uppercase text-sm">Key Facilities</span>
              <span className="w-8 h-1 bg-[#F59E0B] rounded-full"></span>
            </div>
            ...
            {facilities.map((facility) => (
              ...
              >
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  />
                  <div className="absolute top-4 right-4 bg-white text-[#1E3A8A] w-12 h-12 flex items-center justify-center rounded-full shadow-lg group-hover:bg-[#F59E0B] group-hover:text-white transition-colors duration-300 z-10">
                    {facility.icon}
                  </div>
                </div>
                ...
                <div className="p-6 flex-grow flex flex-col justify-between bg-white relative">
                  ...
                  <div className="absolute top-0 left-6 w-12 h-1 bg-[#F59E0B] group-hover:w-full transition-all duration-500"></div>
